...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    // TODO: Connect to EmailJS, Formspree, or your backend API
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:lenoxowino2022@gmail.com"
            ...
            <div className="lg:col-span-3">
              <form
                className="space-y-6 p-6 rounded-xl bg-gradient-card border border-border shadow-card"
              ...
              >
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      required
                      className="bg-secondary border-border focus:border-primary focus:ring-2 focus:ring-primary"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    rows={5}
                    required
                    className="bg-secondary border-border focus:border-primary focus:ring-2 focus:ring-primary resize-none"
                  />
                </div>
